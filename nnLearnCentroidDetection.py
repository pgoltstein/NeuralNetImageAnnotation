...
print("\nLoading data from directory into small_training_image_set:")
...
print(" >> " + small_training_image_set.__str__())

# Dilate centroids
print("Changing dilation factor of small_training_image_set centroids to -3")
...
nn.train_epochs( small_training_image_set,
