...
if perform_network_training:
    ...
    training_image_set.load_data_dir_multipagetiff_xml( training_data_path, normalize=normalize_images, use_channels=[0,1], exclude_border=exclude_border)
...
if perform_network_training:
    ...
    if annotation_type.lower() == 'bodies':
    ...
    if annotation_type.lower() == 'outlines':
