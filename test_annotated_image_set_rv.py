...
# Overall settings
data_path = '/Users/pgoltstein/data/danielle'
im_size = (41,41)
annot_size = (41,41)
...
print(data_path)
ais1.load_data_dir_multipagetiff_xml(data_path, use_channels=[0,1])
print(" >> " + ais1.__str__())
...
samples_grid,_,brdrs = ia.image_grid_RGB( samples,
    ...
    image_size=im_size, n_x=10, n_y=3, channel_order=(0,1),
...
annotations_grid,_,brdrs = ia.image_grid_RGB( annotations,
    ...
    image_size=annot_size, n_x=10, n_y=3, channel_order=(0,1),
